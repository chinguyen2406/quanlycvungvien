...
{{-- <script src="">
  ...
  var regexpass=/\ /;
  if(pass=""){
    check_error_pass.innerHTML="chưa nhập password";
  }else if(regexpass.test(pass)){
    check_error_pass.innerHTML="chứa dấu cách";
  }else{
...
function checkpass(){
  ...
  if(pass == ""){
    check_error_pass.innerHTML="Chưa nhập New pass";
  }else if(!regexpass.test(pass)){
    check_error_pass.innerHTML="Nhập sai New password";
  }else{
    check_error_pass.innerHTML="";
    return pass;
  }
